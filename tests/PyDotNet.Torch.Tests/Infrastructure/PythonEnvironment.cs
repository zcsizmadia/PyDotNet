...
/// <summary>
/// Helper that checks whether Python and torch are available in the current test environment.
...
internal static class PythonEnvironment
{
    ...
    /// <summary>
    /// Skips the calling test when Python is unavailable or torch is not installed.
    /// </summary>
    internal static Task SkipIfUnavailableAsync()
    {
        ...
        {
            throw new SkipTestException(
                $"torch is not installed: {ex.Message}. "
